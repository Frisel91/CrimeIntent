...
// И это
        ...
        reportButton.setOnClickListener{
            Intent(Intent.ACTION_SEND).apply {
                ...
                intent -> val chooserIntent =  Intent.createChooser(intent, getString(R.string.crime_report))
        ...
        photoButton.apply {
            ...
            setOnClickListener {
                ...
                val cameraActivites: List<ResolveInfo>  = packageManager.queryIntentActivities(captureImage,
                PackageManager.MATCH_DEFAULT_ONLY)
...
// Выполняемый здесь запрос — contactUri похож на предложение "where"
                ...
                val cursor = requireActivity().contentResolver.query(contactUri as Uri, queryFields, null, null, null)
                cursor?.use {
